...
### If you have NAs you have to figure out how to deal with NAs. Having NAs kind of mean that you would interpret that the data is inconclusive, has a nonnumerical variable that cannot be used to determine the mean. NAs are useful to designate missing data.One thing it could mean is the data is not available or not applicable to the data set. 
